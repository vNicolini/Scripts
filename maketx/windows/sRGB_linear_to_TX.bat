    ...
    if exist "%%i\" (
        ...
        for %%j in ("%%i\*") do (
            ...
            if not "%%~fj"=="" (
                ...
                "C:\Users\valentin.nicolini\Desktop\PERSO\Pipe\Arnold-7.3.6.0_beta-windows\bin\maketx.exe" -v -u --threads 4 --format exr --checknan --constant-color-detect --opaque-detect --colorconfig %OCIO% --colorconvert "Linear Rec.709 (sRGB)" ACEScg --unpremult --oiio  %%j
        ...
        rem Running maketx command to generate the .exr.tx file
        "C:\Users\valentin.nicolini\Desktop\PERSO\Pipe\Arnold-7.3.6.0_beta-windows\bin\maketx.exe" -v -u --threads 4 --format exr --checknan --constant-color-detect --opaque-detect --colorconfig %OCIO% --colorconvert "Linear Rec.709 (sRGB)" ACEScg --unpremult --oiio  %%i
